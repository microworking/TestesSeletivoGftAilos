...
namespace Questao1
{
    class Program {
        ...
        static void Main(string[] args) {
            ...
            _ = char.TryParse(Console.ReadLine(), out char resp); // considera a ausência de resposta como não
            if (resp == 's' || resp == 'S') {
            ...
            Console.WriteLine(conta.ExibirDadosCliente());
